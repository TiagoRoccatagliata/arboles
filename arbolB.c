 ...
 *
 *  Compilar: gcc -o arbolB arbolB.c -lm
 *  Ejecutar: ./arbolB
 * ============================================================================
 */
...
/* ╔═════════════════════════════════════════════════════════════════════════╗
 * ║                                                                       ║
 * ║               SECCIÓN 2: ÁRBOL AVL (PARA COMPARACIÓN)                 ║
 * ║                                                                       ║
 * ╚═════════════════════════════════════════════════════════════════════════╝
 *
 ...
 *   - Altura del árbol vs B para el mismo conjunto de datos
...
/* ╔═════════════════════════════════════════════════════════════════════════╗
 * ║                                                                       ║
 * ║               SECCIÓN 3: PROGRAMA PRINCIPAL Y COMPARACIONES           ║
 * ║                                                                       ║
 * ╚═════════════════════════════════════════════════════════════════════════╝ */
...
int main(void) {
    printf(NEGRITA "\n");
    printf("  ╔══════════════════════════════════════════════════════════╗\n");
    printf("  ║     IMPLEMENTACIÓN DE ÁRBOL-B Y COMPARACIÓN CON AVL    ║\n");
    printf("  ║                    Orden = %d                            ║\n", ORDEN_B);
    printf("  ╚══════════════════════════════════════════════════════════╝\n" RESET);
    ...
    /* ================================================================
     *  DEMO 2: COMPARACIÓN CON AVL
     * ================================================================ */
    separador("COMPARACIÓN: ÁRBOL-B vs AVL");
    ...
    printf("\n  ┌─────────────────────┬──────────┬──────────┐\n");
    printf("  │     Métrica         │  Árbol-B │   AVL    │\n");
    printf("  ├─────────────────────┼──────────┼──────────┤\n");
    printf("  │ Altura              │    %3d   │   %3d    │\n",
           altura_b, altura_avl);
    printf("  │ Splits/Rotaciones   │    %3ld   │   %3ld    │\n",
           splits_b, rots_avl);

    /* --- Comparar búsquedas --- */
    long comp_b_total = 0, comp_avl_total = 0;
    int busquedas = 100;
    ...
    printf("  │ Comp. búsqueda avg  │  %5.1f   │  %5.1f   │\n",
           (double)comp_b_total / busquedas,
           (double)comp_avl_total / busquedas);
    printf("  │ Elementos           │   %4d   │  %4d    │\n",
           b_inorder_contar(test_b), avl_contar(test_avl));
    printf("  └─────────────────────┴──────────┴──────────┘\n");
    ...
    printf("     B:    O(log_m n) donde m = orden del árbol\n");
    printf("     → Para n=%d y m=%d: B requiere MUCHOS menos niveles.\n", N_PRUEBA, ORDEN_B);
    ...
    printf("     B:    Splits de nodos. Menos frecuentes pero más costosos.\n");
    printf("     → AVL tuvo %ld rotaciones vs %ld splits en B.\n",
           rots_avl, splits_b);
    ...
    printf("     B:    Ideal para disco (nodos = bloques, minimizan I/O).\n");

    printf("\n  " NEGRITA "5. ELIMINACIÓN:" RESET "\n");
    printf("     AVL:  Rotaciones para rebalancear. Máx O(log n) rotaciones.\n");
    printf("     B:    Redistribución o fusión de nodos. Más complejo pero\n");
